...
public class AppUtils {
    ...
    public static void installApp(Context context, String filePath) {
        installApp(context, Files.getFileByPath(filePath));
    }
     ...
     * @param file    文件
     */
    public static void installApp(Context context, java.io.File file) {
     ...
     * @param requestCode 请求值
     */
    public static void installApp(Activity activity, java.io.File file, int requestCode) {
        if (!Files.isFileExists(file)) return;
    ...
    public static boolean installAppSilent(Context context, String filePath) {
        java.io.File file = Files.getFileByPath(filePath);
    ...
    public static boolean cleanAppData(Context context, String... dirPaths) {
        java.io.File[] dirs = new java.io.File[dirPaths.length];
        int i = 0;
        for (String dirPath : dirPaths) {
            dirs[i++] = new java.io.File(dirPath);
        }
     ...
     * @return {@code true}: 成功<br>{@code false}: 失败
     */
    public static boolean cleanAppData(Context context, java.io.File... dirs) {
