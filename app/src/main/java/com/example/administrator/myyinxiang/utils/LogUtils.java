...
public class LogUtils {
    ...
    public static void init(Context context, boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = context.getExternalCacheDir().getPath() + java.io.File.separator;
        } else {
            dir = context.getCacheDir().getPath() + java.io.File.separator;
        }
    ...
    public static Builder getBuilder(Context context) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = context.getExternalCacheDir().getPath() + java.io.File.separator + "log" + java.io.File.separator;
        } else {
            dir = context.getCacheDir().getPath() + java.io.File.separator + "log" + java.io.File.separator;
        }
        return new Builder();
    }
    ...
    private synchronized static void log2File(final char type, final String tag, final String content) {
        ...
        if (!Files.createOrExistsFile(fullPath)) return;
