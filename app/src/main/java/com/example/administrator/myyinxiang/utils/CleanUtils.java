...
public class CleanUtils {
    ...
    public static boolean cleanInternalCache(Context context) {
        return Files.deleteFilesInDir(context.getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles(Context context) {
        return Files.deleteFilesInDir(context.getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs(Context context) {
        return Files.deleteFilesInDir(context.getFilesDir().getParent() + java.io.File.separator + "databases");
    }
    ...
    public static boolean cleanInternalSP(Context context) {
        return Files.deleteFilesInDir(context.getFilesDir().getParent() + java.io.File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache(Context context) {
        return SDCardUtils.isSDCardEnable() && Files.deleteFilesInDir(context.getExternalCacheDir());
    }
    ...
    public static boolean cleanCustomCache(String dirPath) {
        return Files.deleteFilesInDir(dirPath);
    }
     ...
     * @return {@code true}: 清除成功<br>{@code false}: 清除失败
     */
    public static boolean cleanCustomCache(java.io.File dir) {
        return Files.deleteFilesInDir(dir);
    }
}