...
public class IntentUtils {
    ...
    public static Intent getInstallAppIntent(String filePath) {
        return getInstallAppIntent(Files.getFileByPath(filePath));
    }
     ...
     * @return intent
     */
    public static Intent getInstallAppIntent(java.io.File file) {
    ...
    public static Intent getShareImageIntent(String content, String imagePath) {
        return getShareImageIntent(content, Files.getFileByPath(imagePath));
    }
     ...
     * @return intent
     */
    public static Intent getShareImageIntent(String content, java.io.File image) {
        if (!Files.isFileExists(image)) return null;
